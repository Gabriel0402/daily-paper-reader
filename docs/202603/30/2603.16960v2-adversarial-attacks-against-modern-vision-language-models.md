...
result: "LLaVA在多种攻击下成功率最高达66.9%，而Qwen2.5-VL表现出显著更强的对抗韧性，攻击成功率较低。"
conclusion: 简单的梯度攻击对部分开源VLM构成实际威胁，且不同模型架构间的对抗鲁棒性存在显著差异，部署前需严格评估。
---
