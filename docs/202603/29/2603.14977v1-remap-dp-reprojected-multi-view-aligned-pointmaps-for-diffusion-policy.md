...
method: 提出 ReMAP-DP 框架，通过透视重投影生成多视图并结合像素对齐的点图，利用双流架构和模态嵌入融合语义与几何信息。
result: "在 RoboTwin 2.0 上达到 59.3% 的成功率，在 ManiSkill 3 的堆叠任务中比 DP3 提升了 28%，且在现实世界中表现出极高的数据效率。"
conclusion: ReMAP-DP 有效弥合了语义推理与 3D 空间感知之间的鸿沟，为高精度机器人操作提供了一种鲁棒且高效的扩散策略方案。
---
