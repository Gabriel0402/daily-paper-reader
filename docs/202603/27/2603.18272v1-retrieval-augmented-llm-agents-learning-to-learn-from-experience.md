...
tags: ["query:vlm-rl"]
score: 7.0
evidence: 用于强化学习任务的检索增强型LLM智能体
tldr: 本研究针对大语言模型智能体在未知任务上泛化能力不足的问题，提出了一种结合检索增强与微调的框架。通过建立基于LoRA的高效监督微调方案，并系统分析经验检索的最优策略，研究者将检索到的历史轨迹整合进微调过程。该方法使智能体能够从经验中学习，显著提升了在未见任务上的表现，为构建可扩展且具备持续学习能力的智能体提供了有效路径。
selection_source: fresh_fetch
motivation: 现有的微调方法难以推广到新任务，而纯检索方法性能往往不如监督学习，因此需要结合两者优势。
method: 提出一种将经验检索集成到LoRA监督微调中的流水线，并系统优化了存储、查询和轨迹选择策略。
result: 实验表明，该结合方案在处理未知任务时的泛化能力显著优于现有的最先进智能体训练流程。
conclusion: 检索增强的微调框架为构建能够从经验中学习并有效应对新挑战的通用智能体提供了有力支持。
---
