...
tags: ["query:vlm-rl"]
score: 7.0
evidence: 协调跨模态专业工具的智能体AI框架
tldr: 本研究提出了一种自主多模态查询处理的智能体框架，通过中央监督者动态分解任务并协调文本、图像、音频和视频等多种模态工具。该框架利用自适应路由策略而非预设决策树，显著提升了处理效率并降低了成本，为多模态AI的大规模部署提供了高效且经济的编排方案。
selection_source: fresh_fetch
motivation: 针对多模态查询处理中工具协调复杂、效率低下及部署成本高昂的挑战，寻求一种更智能的自动化编排方法。
method: 构建了一个由中央监督者主导的框架，利用RouteLLM进行文本路由，并结合SLM辅助的模态分解来动态委派子任务。
result: "实验显示该框架在保持准确率的同时，减少了72%的响应时间、85%的对话重复率以及67%的运行成本。"
conclusion: 智能化的中央编排机制能够显著优化多模态AI系统的部署经济性，是实现高效自主查询处理的关键。
---
