...
title_zh: 一种用于探索双队列系统多智能体决策中社会交互的框架
authors: "Mallory E. Gaspard, Naomi Ehrich Leonard"
date: 2026-03-30
pdf: "https://arxiv.org/pdf/2603.27972v1"
tags: ["query:gt-mai"]
score: 7.0
evidence: 排队系统中的多智能体决策与社交互动
tldr: 本研究针对双队列系统提出了一种多智能体决策新框架，利用非线性观点动力学来模拟智能体在排队选择时的偏好演化。不同于传统的理性优化模型，该框架引入了受社交互动影响的内部观点状态，能有效捕捉决策中的犹豫过程。研究证明了系统状态在特定条件下可收敛至纳什均衡，并通过仿真展示了社交互动和信息透明度对集体行为的显著影响，为理解复杂服务场景下的群体决策提供了新视角。
selection_source: fresh_fetch
motivation: 传统排队模型通常假设智能体是完全理性的优化者，忽略了社交互动和决策过程中的犹豫心理对群体行为的影响。
method: 引入非线性观点动力学来刻画智能体对队列选择的内部偏好，并将其作为决定加入或切换队列的核心驱动力。
result: 理论证明了在满足特定参数条件时，描述系统演化的马尔可夫链能够在有限期望时间内达到底层拥塞博弈的纳什均衡。
conclusion: 该框架通过数值仿真揭示了社交互动和系统信息获取程度在塑造多智能体系统集体行为中的关键作用。
---

## 摘要
我们引入了一种排队系统中多智能体决策的新框架，该框架利用非线性观点动力学的灵活性和鲁棒性来打破队列选择过程中的犹豫不决，并捕捉社会交互对集体行为的影响。排队模型是理解服务场景中多智能体行为的核心。许多先前的模型假设每个智能体的决策过程是基于优化的，并受对排队系统变化的理性反应所支配。相反，我们引入了一个由非线性观点动力学驱动的内部观点状态，它代表了智能体在两个可用队列之间偏好强度的演变。观点状态受到社会交互的影响，这可以修正纯粹的理性反应。我们提出了一类新的排队模型子类，其中每个智能体的行为决策（例如加入或切换队列）由这种演变的观点状态决定。我们证明了一个充分参数条件，该条件保证了描述演变观点和排队系统状态的马尔可夫链在有限期望时间内达到潜在拥塞博弈的纳什均衡。随后，我们通过数值模拟探索了该新框架的丰富性，阐明了社会交互以及个体获取系统信息的能力在塑造集体行为中的作用。
