...
title_zh: 基于语法约束大语言模型的精准机器人指令理解
authors: "Xinyun Huo, Raghav Gnanasambandam, Xinyao Zhang"
date: 2026-04-05
pdf: "https://arxiv.org/pdf/2604.04233v1"
tags: ["query:vlm-rl"]
score: 8.0
evidence: 语法约束的大语言模型用于精确机器人指令理解
tldr: 本研究针对工业人机协作中指令精确性不足的问题，提出一种语法约束的大语言模型框架。该方法结合微调LLM的推理能力与语法驱动NLU系统的确定性，通过两阶段处理将自然语言转化为标准JSON指令，并引入自动验证与反馈纠错机制。实验证明，该方法在HuRIC数据集上显著提升了指令有效性，为工业机器人提供了更可靠、安全的通信保障。
source: arxiv
